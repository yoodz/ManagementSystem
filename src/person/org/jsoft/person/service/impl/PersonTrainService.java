...
public class PersonTrainService implements IPersonTrainService {
    ...
    public void add(String personnelId, String personnelTrainConten,
        ...
        Personneltrain ptt = new Personneltrain();
        p.setPersonnelId(personnelId);
        ptt.setPersonnelinfo(p);
        ptt.setPersonnelTrainConten(personnelTrainConten);
        ...
        ptt.setPersonnelTrainDate(personnelTrainDate);
        ptt.setPersonnelTrainRemark(personnelTrainRemark);
        ptt.setIsDelete(0);
