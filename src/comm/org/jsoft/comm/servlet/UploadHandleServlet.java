...
import org.jsoft.comm.util.ReadExcel;
...
//        String savePath = this.getServletContext().getRealPath("c:/excel/upload");
//        //上传时生成的临时文件保存目录
//        String tempPath = this.getServletContext().getRealPath("c:/excel/temp");
        String savePath = "c:/excel/upload";
        String tempPath = "c:/excel/temp";
        ...
        try {
            ...
            for (FileItem item : list) {
                ...
                if(item.isFormField()){
                    ...
                    System.out.println("保存路径为:"+savePathStr + File.separator+fileName);
                    ...
                    message = "文件上传成功";
                    //开始将excel写入到数据库中
                    ReadExcel.readExcel(savePathStr + File.separator+fileName);
                }
            }
